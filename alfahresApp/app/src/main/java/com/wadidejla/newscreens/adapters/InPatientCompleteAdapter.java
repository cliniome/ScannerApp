 ...
 */
public class InPatientCompleteAdapter extends ArrayAdapter<RestfulFile> {

    private int resourceId;
    private List<RestfulFile> files;

    public InPatientCompleteAdapter(Context context, int resource) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i == 0) // that means mark file as missing
                                {
                                    ...
                                    try {
                                        ...
                                        InPatientCompleteAdapter.this.notifyDataSetChanged();

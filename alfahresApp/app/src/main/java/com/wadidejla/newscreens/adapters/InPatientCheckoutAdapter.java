 ...
 */
public class InPatientCheckoutAdapter extends ArrayAdapter<RestfulFile> {
    ...
    public InPatientCheckoutAdapter(Context context, int resource) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i == 0) // that means mark file as missing
                                {
                                    ...
                                    try {
                                        ...
                                        InPatientCheckoutAdapter.this.notifyDataSetChanged();

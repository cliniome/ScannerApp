 ...
 */
public class InpatientFilesAdapter extends ArrayAdapter<RestfulFile> {
    ...
    public InpatientFilesAdapter(Context context, int resource) {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i == 0) // that means mark file as missing
                                {
                                    ...
                                    try {
                                        ...
                                        InpatientFilesAdapter.this.notifyDataSetChanged();
    ...
    {
        if(this.files == null) files = new ArrayList<RestfulFile>();
        ...
        {
            RestfulFile foundFile = getFileWithNumber(file.getFileNumber());
